...
INDEX_MAPPING = {
        ...
        9 : 'lava'          ,
        10: 'agent'         ,
        11: 'sand'  # Lava that does not kill the agent
}
...
class NumpyMapMultiRoom(MiniGridEnv):
    ...
    def __init__(self, array, max_steps):
        self.array = array
    ...
    def _gen_grid(self, width, height):
        ...
        for i in range(1, self.array.shape[0]):
            for j in range(1, self.array.shape[1]):
                ...
                if entity_index not in [0,4,8,9,10,11]:
                    for entity_class in WorldObj.__subclasses__():
                        ...
                        if entity_name == entity_class.__name__.casefold():
                            # print('ESTO QUE OSTIAS ES {} at :{},{}'.format(entity_class(),j,i))
                ...
                # agent location
                    ...
                    # agent_position = self.place_obj(None, top=(agent_x,agent_y), size=None, max_tries=math.inf, deterministic_pos=True)
                ...
                # goal location
                    ...
                    goal_x, goal_y = j,i
                    goal_defined = True
                    # goal_position = self.place_obj(obj=Goal(), top=(goal_x,goal_y), deterministic_pos=True)
                    # print('Goal defined at file: [{},{}]'.format(goal_x,goal_y))
                
                elif entity_index == 11:
                    print('sand at :{},{}'.format(j,i))
                    self.put_obj(Quicksand(), j, i)
...
class NumpyMapMultiRoomPartialView(NumpyMapMultiRoom):
	...
	def __init__(self, numpyFile='numpyworldfiles/MN3S8_test_key.npy',max_steps=100):
		...
		super().__init__(self.array, max_steps)
