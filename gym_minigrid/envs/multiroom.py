...
class MultiRoomEnvN5S8(MultiRoomEnv):
    def __init__(self):
        super().__init__(
            minNumRooms=5,
            maxNumRooms=5,
...
class MultiRoomEnvN3S10(MultiRoomEnv):
    def __init__(self):
        super().__init__(
            minNumRooms=3,
            maxNumRooms=3,
...
class MultiRoomEnvN3S20(MultiRoomEnv):
    def __init__(self):
        super().__init__(
            minNumRooms=3,
            maxNumRooms=3,
...
class MultiRoomEnvN5S20(MultiRoomEnv):
    def __init__(self):
        super().__init__(
            minNumRooms=5,
            maxNumRooms=5,
...
register(
    id='MiniGrid-MultiRoom-N5-S8-v0',
    entry_point='gym_minigrid.envs:MultiRoomEnvN5S8'
)
register(
...
register(
    id='MiniGrid-MultiRoom-N3-S10-v0',
    entry_point='gym_minigrid.envs:MultiRoomEnvN3S10'
)


# size 20
register(
    id='MiniGrid-MultiRoom-N3-S20-v0',
    entry_point='gym_minigrid.envs:MultiRoomEnvN3S20'
)

register(
    id='MiniGrid-MultiRoom-N5-S20-v0',
    entry_point='gym_minigrid.envs:MultiRoomEnvN5S20'
)
